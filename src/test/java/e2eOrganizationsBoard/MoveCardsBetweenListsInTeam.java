...
public class MoveCardsBetweenListsInTeam extends BaseTest {
    ...
    public void createNewOrganization(){
        ...
        @Test
        @Order(2)
        public void createNewBoardForOrganization(){

            Response response = given()
                    .spec(reqSpec)
                    .queryParam("name", "Board for organization")
                    .queryParam("defaultLists", false)
                    .queryParam("idOrganization", teamId)
                    .when()
            ...
            JsonPath json = response.jsonPath();
            assertThat(json.getString("name")).isEqualTo("Board for organization");
        ...
        public void addCardToFirstList(){
            ...
            JsonPath json = response.jsonPath();
            assertThat(json.getString("name")).isEqualTo("Card for list");
